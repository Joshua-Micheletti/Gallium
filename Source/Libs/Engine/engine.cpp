...
void Engine::update(RendererManager RM, PhysicsWorld PW) {
    std::vector<std::string> physicsBodies = extractKeys(this->associations_);
    std::vector<std::string> models = extractValues(this->associations_);
